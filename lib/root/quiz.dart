    ...
    try {
      ...
      if (user != null) {
        ...
        safeSetState(() {
          ...
          if (response != null) {
            _activeQuizId = response['id'];
            _selectedSubject = response['subject'];
            _selectedDifficulty = response['difficulty'];
            _currentQuestionIndex = response['current_question'] - 1;
            _score = response['score'];
            _subjectSelected = true;
            _difficultySelected = true;
    ...
    if (_activeQuizId != null) {
      ...
      if (user != null) {
        ...
        if (mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text('Abadnon penalty applied: -20 points'),
...
// Add this new class for subject selection
class _SubjectSelectionView extends StatelessWidget {
  final Function(String) onSubjectSelected;

  const _SubjectSelectionView({
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSubjectCard(
                ...
                title: 'Chemistry',
                description:
                    'Discover the science of matter and its properties',
                icon: Icons.science,
